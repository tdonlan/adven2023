...
input = """Game 1: 1 red, 5 blue, 1 green; 16 blue, 3 red; 6 blue, 5 red; 4 red, 7 blue, 1 green
...
input2 = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""

def getColorMax(color,line):
	count = 0
	match = re.findall(" (\d+) %s" % (color),line)
	for x in match:
		if int(x) > count:
			count = int(x)
	return count
...
for line in input.splitlines():
	...
	num = int(re.findall("Game (\d+):",line)[0])

	blue = getColorMax("blue",line)
	red = getColorMax("red",line)
	green = getColorMax("green",line)

	if red <= 12 and green <= 13 and blue <= 14:
		total = total + num
	print(">" + line)
	print("%d blue: %d red: %d green: %d" % (num, 
	getColorMax("blue",line),
	getColorMax("red",line),
	getColorMax("green",line)))
