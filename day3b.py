...
input = """...............776..............552........968..................589...26...........484..............958......186....546.........484.........
.........*.........778....................*....124...................................*...............*........%..26.........................
...
#get the full box surrounding this number
def getBox(x,y,data):
	numArray = []
	symbol = False
	#traverse to right to full range of number
	while y < len(data[x]):
		if data[x][y].isdigit():
			if checkAdjacent(x,y,data):
				symbol = True
			numArray.append(data[x][y])
		else:
			break
		y = y + 1

	#if adjacent contains symbol, return number, else zero
	if symbol:
		print(numArray)
...
#return true if a symbol is adjacent
def checkAdjacent(x,y,data):
	for i in range(-1,2):
		for j in range(-1,2):
			d = getVal(x+i,y+j,data)
			#print("i:%d j:%d %s" % (i,j,d))
			if d.isdigit() != True and d != ".":
				return True
	return False


#return an array of numbers that are ajacent to this symbol
def getAdjacentNum(x,y,data):
	nums = []
	for i in range(-1,2):
		for j in range(-1,2):
			d = getVal(x+i,y+j,data)
			if d.isdigit():
				nums.append(getFullNum(x+i,y+j,data))
	return list(set(nums))

#return tuple of x,y,num
def getFullNum(x,y,data):
	numArray = []
	#traverse left while still number
	while y > 0:
	...
	while y < len(data[x]):
		if data[x][y].isdigit():
			...
			break
		y = y + 1
	return (x,y,int(''.join(map(str,numArray))))

def isSymbol(x,y,data):
	d = getVal(x,y,data)
	if d.isdigit() == True or d == ".":
		return False
	return True

#return the val if within bounds, else .
def getVal(x,y,data):
...
for x in range(len(data)):
	...
	while y < len(data[x]):
		if isSymbol(x,y,data):
			nums = getAdjacentNum(x,y,data)
			if len(nums) == 2:
				print(nums)
				total = total + (nums[0][2] * nums[1][2])
		y = y + 1
print(total)